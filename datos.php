            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <h2 class="text-white mb-4">Ingrese Datos de los Clientes</h2>
                        <form>
                        <div class="form-group">
                        <p class="text-white-50"><label for="nombre_apellido">Nombre Completo del Cliente</label>
                    ...
                    <div class="form-group">
                        <p class="text-white-50"><label for="telefono">Teléfono</label>
                            <input type="text" class="form-control" id="telefono">
                        </p>
                    <div class="form-group">
                        <p class="text-white-50"><label for="direccion">Dirección</label>
                            <input type="text" class="form-control" id="direccion">
                        </p> 
                        <h2 class="text-white mb-4">Ingrese Datos del Empleado</h2>
                        <div class="form-group">
                            <p class="text-white-50"><label for="nombre">Nombre del Empleado</label>
                            <input type="text" class="form-control" id="nombre">
                        </p>
                        <div class="form-group">
                            <p class="text-white-50"><label for="apellido">Apellido del Empleado</label>
                            <input type="text" class="form-control" id="apellido">
                        </p>
                        <div class="form-group">
                            <p class="text-white-50"><label for="puesto">Puesto</label>
                            <input type="text" class="form-control" id="puesto">
                        </p>
                        <div class="form-group">
                            <p class="text-white-50"><label for="comision">Comision</label>
                            <input type="text" class="form-control" id="comision">
                        </p>
                        <div class="form-group">
                            <p class="text-white-50"> <label for="fotografia_empleado">Fotografia del Empleado</label>
                                <input type="file" class="form-control-file" id="fotografia_empleado">
                            </p>  
                </div>
                </div>
                </div>
                ...
                <div class="mx-auto text-center">
                    <a class="btn btn-primary js-scroll-trigger" href="facturacion.php">Confirmar</a>
                <br></br>
                <br></br>
        </form>
        </section>
