...
<html lang="en">
   ...
   $precio = $_POST['precio'];
   $stock = $_POST['stock'];
   $imagen_repuesto = $_POST['imagen_repuesto'];
   $descripcion = $_POST['descripcion'];
   
 
   $query = "UPDATE repuestos set nombre_repuesto = '$nombre_repuesto', precio = '$precio', stock = '$stock', imagen_repuesto = '$imagen_repuesto', descripcion = '$descripcion'
    
   WHERE id_repuestos=$id_repuestos";
...
<form action="tablarepuestos.php" method="post" >
  <center>
