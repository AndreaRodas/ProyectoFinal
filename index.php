...
<head>
  ...
  <link href="css/tallerbootstrap.css" rel="stylesheet">
          ...
          <div class="masthead-content text-white py-5 py-md-0">
            ...
            <div class="input-group input-group-newsletter">
             ...
             <br></br>
              ...
              <br></br>
                  <button class="btn btn-secondary" type="submit" name="guardar"><nav class="sb-sidenav-menu-nested nav"> <a class="nav-link">Iniciar Sesion</a></nav></button>
          </div>
        </div>
      </div>
    </div>
