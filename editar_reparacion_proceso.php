...
<html lang="en">
   ...
   $query = "UPDATE reparacion set falla = '$falla', observaciones_tecnicas = '$observaciones_tecnicas', fecha_ingreso = '$fecha_ingreso', fecha_egreso = '$fecha_egreso', observacion_final = '$observacion_final'
...
<form action="tablareparacion.php" method="post" >
  <center>
