            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <h2 class="text-white mb-4">Ingrese Datos de la Factura</h2>
                        <form>
                        <div class="form-group">
                        <p class="text-white-50"><label for="fecha_factura">Fecha</label>
                        <input type="text" class="form-control" id="fecha_factura">
                    </p>
                    <div class="form-group">
                        <p class="text-white-50"><label for="id_cliente">Número del Cliente</label>
                        <input type="text" class="form-control" id="id_cliente">
                    </p>
                    <div class="form-group">
                        <p class="text-white-50"><label for="id_reparacion">Número de Reparación</label>
                            <input type="text" class="form-control" id="id_reparacion">
                        </p>
                    <div class="form-group">
                        <p class="text-white-50"><label for="id_vehiculo">Número del Vehículo</label>
                            <input type="text" class="form-control" id="id_vehiculo">
                        </p> 
                        <div class="form-group">
                            <p class="text-white-50"><label for="id_repuesto">Número del Repuesto</label>
                            <input type="text" class="form-control" id="id_repuesto">
                        </p>
                        <div class="form-group">
                            <p class="text-white-50"><label for="id_empleado">Número del Empleado</label>
                            <input type="text" class="form-control" id="id_empleado">
                        </p>
                        <div class="form-group">
                            <p class="text-white-50"><label for="total_factura">Total</label>
                ...
                <div class="mx-auto text-center">
                    <a class="btn btn-primary js-scroll-trigger" href="confirmar.php">Confirmar</a>
                <br></br>
        </form>
        </section>
